package io.github.invvk.mony.internal.config.properties;
...
public class ConfigProperty implements SettingsHolder {
    ...
    @Comment({
            ...
            "  defaultPrice: 100.0",
            "  ",
            "  setting this to false will stop the plugin from giving money for mobs that haven't",
            "  been configured. Meaning in this example below, it will only give money after killing",
            "  a ZOMBIE, other than that it won't give anything.",
